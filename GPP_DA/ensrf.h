		    ...
		    x_b_bar_temp = x_b_bar;
		     for(size_t n = 0;n < obs.size(); ++n){
		     	   /******************
                     	    * STEP 1 check Y_b
                            * ***************/
				if(Y_b(n,0) == -1 || obs[n].value != obs[n].value)
					continue;
		     	   /******************
